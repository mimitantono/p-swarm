...
inline void dprofile_shuffle16(WORD * dprofile, WORD * score_matrix, BYTE * dseq_byte) {
...
inline void dprofile_fill16(WORD * dprofile_word, WORD * score_matrix_word, BYTE * dseq) {
...
inline void donormal16(__m128i * Sm, __m128i * hep, __m128i ** qp, __m128i * Qm, __m128i * Rm, long ql, __m128i * Zm, __m128i * F0,
...
inline void domasked16(__m128i * Sm, __m128i * hep, __m128i ** qp, __m128i * Qm, __m128i * Rm, long ql, __m128i * Zm, __m128i * F0,
...
void searcher::search16(struct search_data* sd, std::vector<unsigned long int> * targets, std::vector<search_result> *result, queryinfo_t * query,
	...
	Q = _mm_set1_epi16(Property::byte_penalty_gapopen_gapextend);
	R = _mm_set1_epi16(Property::byte_penalty_gapextend);
			...
			for (int c = 0; c < CHANNELS; c++) {
				if (d_begin[c] < d_end[c]) {
					...
					if (next_id < sd->target_count) {
						...
						((WORD*) &H0)[c] = 0;
						((WORD*) &F0)[c] = Property::byte_penalty_gapopen_gapextend;
